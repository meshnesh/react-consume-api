...
import { userRegistrationActions } from '../../actions/user.actions';
			...
			<div>
				...
				<div className="row rowParent">
					<form className="col s8 form" name="form" onSubmit={this.handleSubmit}>
						...
						{/* <h1>{ authErrCode.userInfo.user.message }</h1> */}
...
function mapDispatchToProps(dispatch){
	return{
		userRegistrationActions: user =>dispatch(userRegistrationActions(user))
